package tutorial19.shaders;

import org.joml.Matrix4f;
import org.joml.Vector3f;
import tutorial19.entities.Camera;
import tutorial19.entities.Light;
import tutorial19.toolbox.Maths;

public class TerrainShader extends ShaderProgram {

    // указываем пути в константы для загрузки шейдеров
    private static final String VERTEX_FILE = "src/tutorial19/shaders/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial19/shaders/terrainFragmentShader.txt";
