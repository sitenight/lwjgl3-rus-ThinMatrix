...
public class StaticShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/tutorial19/shaders/vertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial19/shaders/fragmentShader.txt";
