...
public class TerrainShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/tutorial14/shaders/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial14/shaders/terrainFragmentShader.txt";
