package tutorial21.shaders;

import org.joml.Matrix4f;
import org.joml.Vector3f;
import tutorial21.entities.Camera;
import tutorial21.entities.Light;
import tutorial21.toolbox.Maths;

public class TerrainShader extends ShaderProgram {

    // указываем пути в константы для загрузки шейдеров
    private static final String VERTEX_FILE = "src/tutorial21/shaders/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial21/shaders/terrainFragmentShader.txt";
