package tutorial18.shaders;

import org.joml.Matrix4f;
import org.joml.Vector3f;
import tutorial18.entities.Camera;
import tutorial18.entities.Light;
import tutorial18.toolbox.Maths;

public class TerrainShader extends ShaderProgram {

    // указываем пути в константы для загрузки шейдеров
    private static final String VERTEX_FILE = "src/tutorial18/shaders/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial18/shaders/terrainFragmentShader.txt";
