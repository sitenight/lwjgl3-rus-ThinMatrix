...
public class StaticShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/tutorial11/shaders/vertexShader.txt";
    private static final String FRAGMENT_FILE = "src/tutorial11/shaders/fragmentShader.txt";
